...
-- ---------------------------------------------------------------------------
-- book_session_with_credits(p_session_id, p_reformer_user_package_id, p_mat_user_package_id)
--
-- Validates and books sessions that can require reformer credits, mat credits,
-- or both. The booking row keeps one primary package for legacy compatibility;
-- booking_credit_charges stores every actual deduction for refunds and display.
-- ---------------------------------------------------------------------------
