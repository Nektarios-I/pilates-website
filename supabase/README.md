...
**Staff Materialize Now (migration 42):** lists/books occurrences through each line’s three-calendar-month planned preview. Daily cron remains the rolling 14-day window.
